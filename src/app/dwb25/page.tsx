    ...
    <main className="bg-[#fcfdfd]">
      ...
      <Container as="section" className="py-10 md:py-16">
        <h2 className="font-[family-name:var(--font-dm-sans)] text-2xl font-bold leading-tight text-[#0a0a0a] md:text-[30px] md:leading-[36px]">
          Kapten Pengabdi Kebanggaan 2025
        </h2>
        <div className="mt-4 flex w-full flex-col gap-4 text-left font-[family-name:var(--font-dm-sans)] text-base leading-7 text-[#0a0a0a] md:mt-6 md:gap-6 md:text-lg md:leading-[28px]">
          <p>
            melakukan pendokumentasian lapangan di sejumlah desa untuk memetakan potensi wisata, ragam kuliner lokal, pemanfaatan tanaman obat, serta budaya dan adat yang masih dijalankan masyarakat. Setiap desa menawarkan karakter tersendiri yang terlihat dari lanskap, aktivitas harian, hingga tradisi yang terus dipertahankan.
          </p>
          <p>
            Uraian lengkap tersebut kami rangkum secara lebih sistematis dalam Dokumen Warisan Banggai Kepulauan. Jelajahi selengkapnya di sini.
          </p>
        </div>
      </Container>
