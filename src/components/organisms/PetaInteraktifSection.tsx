...
export function PetaInteraktifSection() {
  ...
  const currentInfo =
    IslandInformations[selectedIsland] || IslandInformations["island-main"];
    ...
    <Container as="section" className="py-16 md:py-20 overflow-hidden">
      <div className="flex flex-col items-center gap-10 lg:flex-row lg:items-center lg:gap-12">
        ...
        >
          ...
          >
            <PointerIcon className="w-[16px] sm:w-[24px]" />
            Tap To Interact
          </motion.div>
        ...
        >
          <MapInfoCard
            ...
            description={highlightWords(currentInfo.description, keywordsToBold)}
          />
        </motion.div>
      </div>
    </Container>
