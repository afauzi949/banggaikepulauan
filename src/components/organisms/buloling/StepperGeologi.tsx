...
const steps: GeologyStep[] = [
  {
    ...
    title: "Air Meresap",
    description:
      "Air hujan yang sedikit asam meresap melalui celah batuan kapur, perlahan melarutkan mineral penyusun batuan selama ribuan tahun.",
    visual: (
      <svg viewBox="0 0 300 200" className="w-full max-w-sm mx-auto" xmlns="http://www.w3.org/2000/svg">
        ...
        {/* Label */}
        <text x="150" y="100" textAnchor="middle" fontSize="10" fill="#01579b" fontWeight="bold">Air asam meresap ke batuan kapur</text>
      </svg>
    ),
  },
  {
    ...
    title: "Gua Bawah Tanah",
    description:
      "Pelarutan membentuk rongga dan lorong bawah tanah. Air tanah mengalir dan terkumpul, membentuk sistem gua bawah permukaan.",
    visual: (
      <svg viewBox="0 0 300 200" className="w-full max-w-sm mx-auto" xmlns="http://www.w3.org/2000/svg">
        ...
        <text x="150" y="20" textAnchor="middle" fontSize="9" fill="#6b4226" fontWeight="bold">Permukaan Tanah</text>
        <text x="150" y="145" textAnchor="middle" fontSize="9" fill="#01579b" fontWeight="bold">Gua terbentuk — air terkumpul</text>
      </svg>
    ),
  },
  {
    ...
    title: "Atap Menipis",
    description:
      "Pelarutan yang terus berlanjut membuat atap gua kian tipis dan rapuh, hingga retakan struktural mulai muncul.",
    visual: (
      <svg viewBox="0 0 300 200" className="w-full max-w-sm mx-auto" xmlns="http://www.w3.org/2000/svg">
        <rect width="300" height="200" fill="#f8fafc" />
        {/* Thin roof */}
        ...
        <text x="150" y="28" textAnchor="middle" fontSize="9" fill="#dc2626" fontWeight="bold">Retakan struktural muncul!</text>
        <text x="150" y="135" textAnchor="middle" fontSize="9" fill="#01579b">Gua semakin lebar di bawah</text>
      </svg>
    ),
  },
  {
    ...
    title: "Atap Runtuh",
    description:
      "Atap yang tak lagi kuat menahan beban akhirnya runtuh, menyingkap rongga bawah tanah ke permukaan.",
    visual: (
      <svg viewBox="0 0 300 200" className="w-full max-w-sm mx-auto" xmlns="http://www.w3.org/2000/svg">
        <rect width="300" height="200" fill="#e0f7fa" />
        {/* Ground sides */}
        ...
        <text x="150" y="20" textAnchor="middle" fontSize="10" fill="#92400e" fontWeight="bold">💥 Atap runtuh!</text>
        <text x="150" y="145" textAnchor="middle" fontSize="9" fill="white" fontWeight="bold">Rongga tersingkap ke permukaan</text>
      </svg>
    ),
  },
  {
    ...
    title: "Cenote Terbentuk",
    description:
      "Vegetasi tumbuh di tepian, ekosistem akuatik berkembang — cenote menjadi jendela alami menuju akuifer bawah tanah.",
    visual: (
      <svg viewBox="0 0 300 200" className="w-full max-w-sm mx-auto" xmlns="http://www.w3.org/2000/svg">
        {/* Sky */}
        <rect width="300" height="200" fill="#e0f7fa" />
        ...
        {/* Labels */}
        <text x="150" y="125" textAnchor="middle" fontSize="10" fill="white" fontWeight="bold">Cenote — Akuifer Terbuka</text>
      ...
      <div className="mx-auto w-full max-w-[1200px] px-4 sm:px-6 md:px-8">
        ...
        >
          ...
          <p className="text-zinc-600 max-w-xl mx-auto">
            Perjalanan ribuan tahun dalam 5 tahap — klik tiap tahap untuk membuka ceritanya.
          </p>
        </motion.div>
